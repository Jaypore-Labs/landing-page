...
- [Your AI coding assistant is a midwife, not a genius](/blog/ai-assistant-is-a-midwife) — the same handing-back-agency principle, applied to engineering tools.
- [Prompts are recipes, not spells](/blog/prompts-are-recipes) — how to structure the "scribal house style" in a prompt file.
- [Your AI agent should plan like a kitchen brigade](/blog/ai-agent-kitchen-brigade) — when a scribe ought to be one station among many.
