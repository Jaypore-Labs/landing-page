...
- [MCP servers are USB-C for AI](/blog/mcp-is-usb-c-for-ai) — the protocol that makes tool-calling portable across stations.
- [Prompts are recipes, not spells](/blog/prompts-are-recipes) — what the pass schema between agents actually looks like in practice.
- [Your AI coding assistant is a midwife, not a genius](/blog/ai-assistant-is-a-midwife) — the same handing-back-agency principle applied to dev tools.
